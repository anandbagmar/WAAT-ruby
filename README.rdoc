...
See the WAAT (Java) project here http://github.com/anandbagmar/WAAT for more specifics.

=== Latest version
Latest version of WAAT-Ruby will be available soon.
Latest version of WAAT-Java v1.3 is available from the WAAT-Java dist folder (https://github.com/anandbagmar/WAAT/tree/master/dist).
...
The idea for the WAAT was initially incubated as part of a project for Sears.  The author greatly appreciates Sears' support of releasing the WAAT to the public.

For any other questions, comments, help, email Anand Bagmar @ abagmar@gmail.com

Description goes here.

== Contributing to WAAT-ruby
