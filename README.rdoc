...
* initialize_waat
    ...
    See **initailze_waat** method definition in {WAAT.rb}[https://github.com/anandbagmar/WAAT-ruby/blob/master/lib/WAAT.rb] for usage information
...
* verify_web_analytics_data
    ...
    See **verify_web_analytics_data** method definition in {WAAT.rb}[https://github.com/anandbagmar/WAAT-ruby/blob/master/lib/WAAT.rb] for usage information

* Default plugin: HttpSniffer
    v1.4.0 only supported the http_sniffer plugin.
    v1.5.0 supports http_sniffer and js_sniffer plugins, with http_sniffer being the default.
