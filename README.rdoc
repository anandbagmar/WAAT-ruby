...
<b>WAAT = Web Analytics Automation Testing.</b>
...
* See my blog for all activity around WAAT - http://essenceoftesting.blogspot.com/search/label/waat

=== Latest version
* <b>WAAT-Ruby will be available soon.</b>
* <b>WAAT-Java v1.3 is available from the WAAT-Java dist folder (https://github.com/anandbagmar/WAAT/tree/master/dist).</b>
