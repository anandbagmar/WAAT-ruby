...
* initialize_waat
    ...
    -
    v1.5.0: initialize_waat now takes an optional hash. See {initailze_waat method definition in WAAT.rb}[https://github.com/anandbagmar/WAAT-ruby/blob/master/lib/WAAT.rb] for usage information

* verify_web_analytics_data
    v1.4.0: This method took a Array as an input
    -
    v1.5.0: This method now takes a Hash as an input, with symbols as keys. See {verify_web_analytics_data method definition in WAAT.rb}[https://github.com/anandbagmar/WAAT-ruby/blob/master/lib/WAAT.rb] for usage information

* Default plugin: HttpSniffer
    v1.4.0 only supported the http_sniffer plugin.
    v1.5.0 supports http_sniffer and js_sniffer plugins, with http_sniffer being the default. To override, initialize WAAT using the following command:
