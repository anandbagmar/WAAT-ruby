...
** v1.5.0: initialize_waat now takes an optional hash. See {WAAT.rb}[https://github.com/anandbagmar/WAAT-ruby/blob/master/lib/WAAT.rb] for usage information

* Default plugin: Http_Sniffer
